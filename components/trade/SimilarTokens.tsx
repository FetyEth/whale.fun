 ...
 */
const SimilarTokens: React.FC<SimilarTokensProps> = ({
  currentTokenAddress,
  chainId,
}) => {
    ...
    (async () => {
      try {
        ...
        const filtered = all.filter(
          (t) =>
            t.id.toLowerCase() !== (currentTokenAddress || "").toLowerCase()
        );
    ...
    <div className="rounded-2xl bg-[#2B2B2B] text-white border-none shadow-lg">
        ...
        <div className="flex justify-between items-center min-h-[52px]">
          <div className="flex flex-col justify-center">
            ...
            <div className="text-sm text-white/70 mt-1">
              Some other tokens that you might like
            </div>
          </div>
          <Link
            href="/explore"
      ...
      <div className="relative px-4 pb-4 mx-3">
        {loading ? (
          ...
          <div className="h-[120px] grid place-items-center text-white/60">
          ...
          <div className="relative">
            ...
            <div
              ref={scrollerRef}
              className="flex gap-4 overflow-x-auto no-scrollbar pb-2 pr-8"
            >
