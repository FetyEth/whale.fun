...
async function main() {
  console.log(
    "🚀 Deploying COMPLETE Whale.fun Platform with Viem to Amoy Testnet...\n"
  );
  ...
  if (balance === 0n) {
    console.log(
      "⚠️  Warning: Account balance is 0. Make sure you have MATIC for gas fees."
    );
  }
  ...
  const TokenGraduationArtifact = await hre.artifacts.readArtifact(
    "TokenGraduation"
  );
  const TokenAnalyticsArtifact = await hre.artifacts.readArtifact(
    "TokenAnalytics"
  );
  const TradingEngineArtifact = await hre.artifacts.readArtifact(
    "TradingEngine"
  );
  const BossBattleArenaArtifact = await hre.artifacts.readArtifact(
    "BossBattleArena"
  );
  ...
  try {
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + whaleTokenHash
    );
    console.log("");
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + tokenFactoryHash
    );
    console.log("");
    ...
    const tradingEngineHash = await walletClient.deployContract({
      ...
      args: [
        whaleTokenReceipt.contractAddress,
        tokenFactoryReceipt.contractAddress,
      ],
    });
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + tradingEngineHash
    );
    console.log("");
    ...
    const bossBattleArenaHash = await walletClient.deployContract({
      ...
      args: [
        whaleTokenReceipt.contractAddress,
        tradingEngineReceipt.contractAddress,
        account.address,
      ],
    });
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + bossBattleArenaHash
    );
    console.log("");
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + tokenGraduationHash
    );
    console.log("");
    ...
    console.log(
      "   Explorer: https://amoy.polygonscan.com/tx/" + tokenAnalyticsHash
    );
    console.log("");
    ...
    try {
      ...
      console.log("✅ Factory stats updated:", {
        ...
        totalFeesCollected:
          (Number(newFactoryStats[2]) / 1e18).toFixed(4) + " MATIC",
      });
      ...
      const tradingEngineWhaleToken =
        await tradingEngineContract.read.whaleToken();
      const tradingEngineTokenFactory =
        await tradingEngineContract.read.tokenFactory();
      console.log("✅ TradingEngine test passed:", {
        ...
        correctlyLinked:
          tradingEngineWhaleToken.toLowerCase() ===
          whaleTokenReceipt.contractAddress.toLowerCase(),
      });
    ...
    console.log(
      "BossBattleArena: " + deploymentResults.BossBattleArena.address
    );
    console.log(
      "TokenGraduation: " + deploymentResults.TokenGraduation.address
    );
